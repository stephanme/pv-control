...
class GoeWallboxTest(unittest.TestCase):
    ...
    def test_json_2_wallbox_data(self):
        ...
        self.assertEqual(WallboxData(0, WbError.OK, CarStatus.NoVehicle, 10, True, False, 1, 0, 0, 0, 12000), wb)
        # phase relay error
        wb = self.wallbox._json_2_wallbox_data(wb_json, True)
        self.assertEqual(WallboxData(0, WbError.PHASE_RELAY_ERR, CarStatus.NoVehicle, 10, True, True, 1, 0, 0, 0, 12000), wb)
