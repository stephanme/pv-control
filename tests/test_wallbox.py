...
from pvcontrol.wallbox import CarStatus, GoeWallbox, GoeWallboxConfig, WallboxData
...
class GoeWallboxTest(unittest.TestCase):
    ...
    def test_json_2_wallbox_data(self):
        ...
        self.assertEqual(WallboxData(0, CarStatus.NoVehicle, 10, True, 1, 0, 0, 0, 12000), wb)
